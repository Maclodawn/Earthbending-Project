...
public class CharacterMovementEarth : CharacterMovement
{
    ...
    protected override void basicAttack1()
    {
        ...
        if (colliderList.Length > 0)
        {
            ...
            else
            {
                ...
                bullet.fling(gameObject, m_attack1ForceUp, m_attack1ForceForward, false);
            }
        }
        else
            spawnAndFlingBullet(gameObject, m_attack1ForceUp, m_attack1ForceForward);
    ...
    void spawnAndFlingBullet(GameObject _user, float _forceUp, float _forceForward)
    {
    ...
    protected override void basicAttack2()
    {
        ...
        {
            breakableRock.breakRock(gameObject, m_attack1ForceUp, m_attack1ForceForward);
        }
        else
        {
            if (!collided)
